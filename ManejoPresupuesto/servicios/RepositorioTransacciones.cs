...
namespace ManejoPresupuesto.servicios
{
    ...
    public class RepositorioTransacciones : IRepositorioTransacciones
    {
        ...
        public async Task<Transaccion> ObtenerPorId(int id, int usuarioId)
        {
            ...
            return await connection.QueryFirstOrDefaultAsync<Transaccion>(@"SELECT Transacciones.*, cat.TipoOperacionId 
                     ...
                     WHERE Transacciones.Id = @Id 
                       AND Transacciones.UsuarioId = @UsuarioId", new { Id = id, UsuarioId = usuarioId });
        ...
        {
            using var connection = new SqlConnection(connectionString);
            await connection.ExecuteAsync("Transacciones_Borrar", new { Id = id }, commandType: System.Data.CommandType.StoredProcedure);
        }
    }
}
